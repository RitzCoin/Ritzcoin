...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "RitzCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    ...
    {"cryptolife.net","162.243.239.239"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. RitzCoin is probably already running."), addrBind.ToString().c_str());
        else
